    ...
    >
      <SearchField label="Where" htmlFor="coliving-city">
        <select
          ...
          className="min-h-[2.75rem] w-full cursor-pointer bg-transparent text-base text-foreground focus:outline-none focus-visible:rounded-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--ring)] sm:min-h-0 sm:text-sm"
